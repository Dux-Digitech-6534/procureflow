...
const en: Record<string, string> = {
	...
	'home.receiveHint': 'Tap to receive & make the receipt',
	'home.new': 'New',
	...
	// new purchase order (from approved MR)
	'npo.new': 'New PO',
	'npo.title': 'New purchase order',
	'npo.mrLabel': 'Approved request',
	'npo.pickMr': 'Pick an approved request…',
	'npo.pickMrHint': 'Its items load below. One project per order.',
	'npo.requests': 'Approved requests (optional)',
	'npo.addRequest': 'Add an approved request…',
	'npo.sameProject': 'All requests must be from the same project.',
	'npo.sameProjectHint': 'Add more requests from the same project, or add items below.',
	'npo.standaloneHint': 'Pull items from approved requests — or skip this and build the order directly.',
	'npo.addItem': 'Add an item…',
	'npo.pickMrFirst': 'Add a request first',
	'npo.pickCategoryFirst': 'Pick a category first',
	'npo.extraItem': 'Added item',
	'npo.projectPlaceholder': 'Select project…',
	'npo.categoryPlaceholder': 'Select category…',
	'npo.lockedByMr': 'Set from the added request',
	'npo.errProject': 'Select a project.',
	'npo.project': 'Project',
	'npo.category': 'Category',
	'npo.requestedBy': 'Requested by',
	'npo.supplier': 'Supplier',
	'npo.supplierPlaceholder': 'Select supplier…',
	'npo.taxType': 'Tax',
	'npo.taxTypeLabel': 'Tax type',
	'npo.taxTypePlaceholder': 'Select tax type…',
	'npo.taxTypeHint': 'Auto-detected from supplier vs company; set it if not detected.',
	'npo.errTax': 'Select the tax type (Intra-State or Inter-State).',
	'npo.receiver': 'Receiver',
	'npo.receiverPlaceholder': 'Who will receive this material…',
	'npo.receiverHint': 'Required to place the order — only they can make the receipt.',
	'npo.rate': 'Rate',
	'npo.gst': 'GST',
	'npo.lineTotal': 'Line total (incl. tax)',
	'npo.total': 'Total (incl. tax)',
	'npo.noItems': 'This request has nothing left to order.',
	'npo.saveDraft': 'Save draft',
	'npo.submit': 'Place / send for approval',
	'npo.submitting': 'Saving…',
	'npo.savedDraft': 'Saved as draft',
	'npo.sentForApproval': 'Sent for approval',
	'npo.ordered': 'Order placed',
	'npo.errMr': 'Pick an approved material request.',
	'npo.errSupplier': 'Select a supplier.',
	'npo.errItems': 'No items to order.',
	'npo.errQty': 'Every item needs a quantity.',
	'npo.dupItem': 'Same item added again — use the specification to tell the lines apart.',
	'npo.errRate': 'Set a rate for every item before placing the order.',
	'npo.errReceiver': 'Assign a receiver before placing the order.',
	'npo.leaveMsg': 'Your purchase order isn’t saved yet. Leave anyway?',
	...
	'nr.editTitle': 'Edit request',
	'nr.cannotEditSubmitted': 'This request is already submitted and can’t be edited.',
	...
	'nr.dupItem': 'Same item added again — use the specification to tell the lines apart.',
	...
	'd.edit': 'Edit',
	'd.delete': 'Delete',
	'd.deleteConfirm': 'Tap again to confirm delete',
	'd.deleting': 'Deleting…',
	'd.deleted': 'Deleted',
	'd.cancelDoc': 'Cancel document',
	'd.cancelConfirm': 'Tap again to confirm cancel',
	'd.cancelling': 'Cancelling…',
	'd.cancelled': 'Cancelled',
	'd.order': 'Order',
	'd.remaining': 'Remaining {n} {uom} · received {r} of {o}',
	'd.fullyReceived': 'Fully received',
	'd.receipt': 'Receipt',
	'd.project': 'Project',
	'd.category': 'Category',
	'd.supplier': 'Supplier',
	...
	'd.advance': 'Advance',
	'd.advancePaid': 'Advance paid',
	'd.advanceApplied': 'Applied to receipts',
	'd.advanceUnapplied': 'Unapplied credit',
	'd.payAdvance': 'Pay advance',
	'd.fromAdvance': 'of which PO advance',
	'd.payment': 'Payment',
...
const hi: Record<string, string> = {
	...
	'home.receiveHint': 'टैप करें — माल रिसीव करके रिसीट बनाएँ',
	'home.new': 'नया',
	...
	// new purchase order (from approved MR)
	'npo.new': 'नया PO',
	'npo.title': 'नया परचेज़ ऑर्डर',
	'npo.mrLabel': 'अप्रूव्ड रिक्वेस्ट',
	'npo.pickMr': 'कोई अप्रूव्ड रिक्वेस्ट चुनें…',
	'npo.pickMrHint': 'इसके आइटम नीचे आ जाएँगे। एक ऑर्डर में एक ही प्रोजेक्ट।',
	'npo.requests': 'अप्रूव्ड रिक्वेस्ट (ज़रूरी नहीं)',
	'npo.standaloneHint': 'अप्रूव्ड रिक्वेस्ट से आइटम लें — या इसे छोड़कर सीधे ऑर्डर बनाएँ।',
	'npo.pickCategoryFirst': 'पहले कैटेगरी चुनें',
	'npo.projectPlaceholder': 'प्रोजेक्ट चुनें…',
	'npo.categoryPlaceholder': 'कैटेगरी चुनें…',
	'npo.lockedByMr': 'जोड़ी गई रिक्वेस्ट से तय',
	'npo.errProject': 'प्रोजेक्ट चुनें।',
	'npo.addRequest': 'अप्रूव्ड रिक्वेस्ट जोड़ें…',
	'npo.sameProject': 'सभी रिक्वेस्ट एक ही प्रोजेक्ट की होनी चाहिए।',
	'npo.sameProjectHint': 'इसी प्रोजेक्ट की और रिक्वेस्ट जोड़ें, या नीचे आइटम जोड़ें।',
	'npo.addItem': 'आइटम जोड़ें…',
	'npo.pickMrFirst': 'पहले रिक्वेस्ट जोड़ें',
	'npo.extraItem': 'जोड़ा गया आइटम',
	'npo.project': 'प्रोजेक्ट',
	'npo.category': 'कैटेगरी',
	'npo.requestedBy': 'रिक्वेस्ट की',
	'npo.supplier': 'सप्लायर',
	'npo.supplierPlaceholder': 'सप्लायर चुनें…',
	'npo.taxType': 'टैक्स',
	'npo.taxTypeLabel': 'टैक्स टाइप',
	'npo.taxTypePlaceholder': 'टैक्स टाइप चुनें…',
	'npo.taxTypeHint': 'सप्लायर/कंपनी से अपने-आप पता चलता है; न पता चले तो खुद चुनें।',
	'npo.errTax': 'टैक्स टाइप चुनें (इंट्रा-स्टेट या इंटर-स्टेट)।',
	'npo.receiver': 'रिसीवर',
	'npo.receiverPlaceholder': 'यह माल कौन रिसीव करेगा…',
	'npo.receiverHint': 'ऑर्डर देने के लिए ज़रूरी — रिसीट यही बना सकता है।',
	'npo.rate': 'रेट',
	'npo.gst': 'GST',
	'npo.lineTotal': 'लाइन टोटल (टैक्स सहित)',
	'npo.total': 'टोटल (टैक्स सहित)',
	'npo.noItems': 'इस रिक्वेस्ट में ऑर्डर करने को कुछ बाकी नहीं है।',
	'npo.saveDraft': 'ड्राफ्ट सेव करें',
	'npo.submit': 'ऑर्डर दें / अप्रूवल भेजें',
	'npo.submitting': 'सेव हो रहा है…',
	'npo.savedDraft': 'ड्राफ्ट सेव हो गया',
	'npo.sentForApproval': 'अप्रूवल के लिए भेज दिया',
	'npo.ordered': 'ऑर्डर दे दिया',
	'npo.errMr': 'कोई अप्रूव्ड मटीरियल रिक्वेस्ट चुनें।',
	'npo.errSupplier': 'सप्लायर चुनें।',
	'npo.errItems': 'ऑर्डर करने को कोई आइटम नहीं।',
	'npo.errQty': 'हर आइटम की क्वांटिटी डालें।',
	'npo.dupItem': 'वही आइटम फिर से जुड़ा है — लाइनों में फर्क बताने के लिए स्पेसिफिकेशन लिखें।',
	'npo.errRate': 'ऑर्डर देने से पहले हर आइटम का रेट डालें।',
	'npo.errReceiver': 'ऑर्डर देने से पहले रिसीवर चुनें।',
	'npo.leaveMsg': 'आपका परचेज़ ऑर्डर अभी सेव नहीं हुआ। फिर भी जाएँ?',
	...
	'nr.editTitle': 'रिक्वेस्ट एडिट करें',
	'nr.cannotEditSubmitted': 'यह रिक्वेस्ट सबमिट हो चुकी है, अब एडिट नहीं हो सकती।',
	'nr.category': 'कैटेगरी',
	...
	'nr.dupItem': 'वही आइटम फिर से जुड़ा है — लाइनों में फर्क बताने के लिए स्पेसिफिकेशन लिखें।',
	...
	'd.edit': 'एडिट करें',
	'd.delete': 'डिलीट करें',
	'd.deleteConfirm': 'पक्का डिलीट? फिर से दबाएँ',
	'd.deleting': 'डिलीट हो रहा है…',
	'd.deleted': 'डिलीट हो गया',
	'd.cancelDoc': 'कैंसिल करें',
	'd.cancelConfirm': 'पक्का कैंसिल? फिर से दबाएँ',
	'd.cancelling': 'कैंसिल हो रहा है…',
	'd.cancelled': 'कैंसिल हो गया',
	'd.order': 'ऑर्डर',
	'd.remaining': 'बाकी {n} {uom} · {o} में से {r} मिला',
	'd.fullyReceived': 'पूरा मिल गया',
	'd.receipt': 'रिसीप्ट',
	'd.project': 'प्रोजेक्ट',
	'd.category': 'कैटेगरी',
	'd.supplier': 'सप्लायर',
	...
	'd.advance': 'एडवांस',
	'd.advancePaid': 'एडवांस दिया',
	'd.advanceApplied': 'रसीदों में लगाया',
	'd.advanceUnapplied': 'बचा हुआ एडवांस',
	'd.payAdvance': 'एडवांस दें',
	'd.fromAdvance': 'इसमें PO एडवांस',
	'd.payment': 'पेमेंट',
