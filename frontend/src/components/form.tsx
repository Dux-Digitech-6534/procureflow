...
/**
 * Form primitives styled per the DUX design system's Input spec (hairline
 * border, iris focus ring) — see .field/.inp rules in app.css.
 */
...
/** Searchable combobox. Type to filter, click to pick, × to clear. Portals the
 *  dropdown to <body> and flips ABOVE the input when there's more room there. */
export function SearchSelect({
	...
	useEffect(() => {
		...
		function place() {
			...
			const maxH = Math.max(180, Math.min(420, (openUp ? above : below) - 12));
