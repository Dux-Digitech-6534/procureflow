...
const PATHS: Record<string, string> = {
	...
	whatsapp: '<path d="M20.5 11.8a8.5 8.5 0 0 1-12.6 7.4L3.5 20.5l1.3-4.3A8.5 8.5 0 1 1 20.5 11.8z"/><path d="M8.6 8.4c.15-.35.3-.36.55-.37h.45c.15 0 .35.05.5.45l.55 1.3c.07.18.02.35-.08.5l-.4.45c-.1.13-.16.27-.05.46.3.5.74.96 1.27 1.28.4.24.6.22.78.05l.4-.45c.16-.16.3-.16.5-.08l1.25.6c.2.1.3.25.3.4 0 .4-.45 1.1-.85 1.28-.4.18-1.3.3-2.7-.6-1.6-1-2.55-2.75-2.65-2.95-.1-.2-.6-1.1-.4-1.6z"/>',
	...
	logout: '<path d="M15 4h3a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-3"/><path d="M10 17l5-5-5-5"/><path d="M15 12H3"/>',
	camera: '<path d="M4 8h3l1.7-2h6.6L17 8h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/><circle cx="12" cy="13" r="3.4"/>',
